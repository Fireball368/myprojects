...
// variable that tallys the total donation amount
var donationTotal = 0;
...
// applies the calSum function using the forEach method 
donors.forEach(calcSum);
//creates the summary table with the total donation amount and the number of donors 
var summaryTable = "<table>" +
				"<tr><th>Donors</th><td>" + donors.length + "</td></tr>" +
				"<tr><th>Total Donations</th><td>" + "$" +donationTotal.toLocaleString() + "</td></tr>" +
			    "</table>";
//writes in the html code to the document				
document.getElementById("donationSummary").innerHTML = summaryTable;
//creates the majorDonors array from the findMajorDonors function
var majorDonors = donors.filter(findMajorDonors);
//sorts the majorDonors array by descending
majorDonors.sort(donorSortDescending);
// adds the major donors table
